...
const KohemaxPage = () => {
  ...
  const benefits = [
    {
      ...
      description:
        "Mengembalikan nutrisi alami untuk pertumbuhan tanaman optimal",
    },
    {
      icon: <Sprout className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600" />,
    ...
    },
    {
      ...
      description:
        "Mengandung NPK (1,0:0,5:1,5) plus Ca & Mg untuk tanaman sehat",
    },
    {
      icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-lime-600" />,
      title: "Ramah lingkungan",
      description: "Fermentasi dengan EM4 mengurangi bau dan limbah",
    },
    {
      icon: <Users className="w-6 h-6 sm:w-8 sm:h-8 text-amber-600" />,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-amber-50">
      ...
      <section className="relative bg-gradient-to-br from-green-700 via-lime-700 to-amber-800 pt-16 sm:pt-24 pb-12 sm:pb-20 min-h-[50vh] sm:min-h-[60vh] flex items-center overflow-hidden text-white">
        {/* Background decorative elements - Hidden on mobile */}
        <div
          className="hidden sm:block absolute top-20 right-10 w-32 h-32 bg-lime-300 rounded-full opacity-30 blur-3xl transition-transform duration-1000 ease-out"
          style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8 sm:gap-12 relative z-10">
          ...
          >
            ...
            <div className="space-y-2 sm:space-y-4">
              ...
              >
                Pupuk organik fermentasi berbahan kotoran kambing, dolomit,
                serabut kelapa, dan EM4. Kaya nutrisi, ramah lingkungan, dan
                bebas bau menyengat.
              </p>
            </div>
            ...
            >
              <div className="text-center p-2 sm:p-3 bg-white/10 rounded-lg sm:rounded-xl backdrop-blur-sm">
                <Zap className="w-4 sm:w-6 h-4 sm:h-6 text-lime-300 mx-auto mb-1" />
              ...
              <div className="text-center p-2 sm:p-3 bg-white/10 rounded-lg sm:rounded-xl backdrop-blur-sm">
                <Heart className="w-4 sm:w-6 h-4 sm:h-6 text-amber-300 mx-auto mb-1" />
                <div className="text-xs sm:text-sm font-semibold">
                  Ramah Lingkungan
                </div>
            ...
            >
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm">
                <div className="w-2 sm:w-3 h-2 sm:h-3 bg-lime-300 rounded-full"></div>
                <span>Buah</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-green-50 via-lime-50 to-amber-50 relative overflow-hidden">
        {/* Animated background elements - Hidden on mobile */}
        <div className="hidden sm:block absolute top-0 left-0 w-full h-full">
          <div className="absolute top-20 left-10 w-32 h-32 bg-green-200 rounded-full opacity-20 animate-pulse"></div>
          <div
            className="absolute bottom-20 right-20 w-24 h-24 bg-lime-200 rounded-full opacity-30 animate-bounce"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-green-500 to-lime-500 text-white rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6 shadow-lg">
            ...
            {nutritionFacts.map((item, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 sm:hover:-translate-y-3 group-hover:scale-105 border border-gray-100 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-lime-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl sm:rounded-3xl"></div>
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="relative mb-3 sm:mb-4">
                      ...
                      >
                        {item.nutrient === "Nitrogen (N)" && (
                          <Zap className="w-4 sm:w-5 md:w-8 h-4 sm:h-5 md:h-8 text-white" />
                        )}
                        {item.nutrient === "Fosfor (P)" && (
                          <Heart className="w-4 sm:w-5 md:w-8 h-4 sm:h-5 md:h-8 text-white" />
                        )}
                        {item.nutrient === "Kalium (K)" && (
                          <Shield className="w-4 sm:w-5 md:w-8 h-4 sm:h-5 md:h-8 text-white" />
                        )}
                        {item.nutrient === "Kalsium & Magnesium" && (
                          <Award className="w-4 sm:w-5 md:w-8 h-4 sm:h-5 md:h-8 text-white" />
                        )}
                      </div>

                      {/* Floating indicator - Mobile Responsive */}
                      <div className="absolute -top-1 sm:-top-2 -right-1 sm:-right-2 w-4 sm:w-5 md:w-6 h-4 sm:h-5 md:h-6 bg-gradient-to-r from-green-400 to-lime-400 rounded-full flex items-center justify-center shadow-md transform group-hover:scale-125 transition-all duration-300">
                    ...
                    {/* Nutrient name - Mobile Responsive */}
                ...
                <div className="hidden sm:block absolute inset-0 bg-gradient-to-br from-green-200 to-lime-200 rounded-3xl opacity-0 group-hover:opacity-20 transform translate-y-2 group-hover:translate-y-4 transition-all duration-500 -z-10 blur-xl"></div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 sm:mt-16 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-4 sm:px-8 py-4 sm:py-6 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-white/50">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 md:w-12 h-8 sm:h-10 md:h-12 bg-gradient-to-r from-lime-400 to-lime-600 rounded-lg sm:rounded-xl flex items-center justify-center">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 md:w-12 h-8 sm:h-10 md:h-12 bg-gradient-to-r from-amber-400 to-amber-600 rounded-lg sm:rounded-xl flex items-center justify-center">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-50 via-green-50/30 to-lime-50/50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-500 to-lime-500 text-white rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Pupuk organik premium untuk kesuburan tanah dan pertumbuhan
              tanaman optimal
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform group-hover:-translate-y-2 sm:group-hover:-translate-y-4 group-hover:scale-105 border border-gray-100/50 backdrop-blur-sm overflow-hidden">
                  {/* Gradient overlay on hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-green-50 via-transparent to-lime-50 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl sm:rounded-3xl"></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="hidden sm:flex items-center gap-2 mt-4 md:mt-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                      <div className="w-1 h-6 md:h-8 bg-gradient-to-b from-green-500 to-lime-500 rounded-full"></div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-green-50 to-lime-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-green-800 mb-3 sm:mb-4">
              Pilihan Jenis & Kemasan
            </h2>
            <p className="text-sm sm:text-lg text-green-600">
              Sesuaikan dengan kebutuhan pertanian Anda
            </p>
          </div>
                ...
                >
                  {type.popular && (
                    <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2">
                      <span className="bg-lime-500 text-white px-2 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-bold">
                        Terpopuler
                      </span>
                    </div>
                  )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {packages.map((pkg) => (
                <div
                  ...
                  className={`relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${
                    selectedPackage === pkg.weight
                      ? "ring-2 sm:ring-4 ring-green-500"
                      : ""
                  } ${pkg.popular ? "ring-2 ring-lime-400" : ""} ${
                ...
                >
                  ...
                  {pkg.special && (
                    <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2">
                      <span className="bg-amber-500 text-white px-2 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-bold">
                        Special
                      </span>
                    </div>
                  )}
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-gray-50 to-green-50 relative overflow-hidden">
        ...
        <div className="hidden sm:block absolute bottom-10 right-10 w-48 h-48 bg-lime-100 rounded-full opacity-40 blur-2xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              4 langkah sederhana untuk mendapatkan pupuk organik KOHEMAX
              berkualitas
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 relative">
            ...
            {[
              ...
              },
              {
                ...
                icon: (
                  <Sprout className="w-5 sm:w-6 md:w-8 h-5 sm:h-6 md:h-8" />
                ),
          ...
          <div className="text-center mt-10 sm:mt-16">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-4 sm:px-8 py-4 sm:py-4 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-green-100">
              ...
              <div className="flex items-center gap-2 sm:gap-3 text-lime-600">
                <CheckCircle className="w-4 sm:w-5 h-4 sm:h-5" />
                <span className="text-sm sm:text-base font-semibold">
                  Jaminan kualitas & higienis
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-green-700 via-lime-700 to-amber-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
            Siap Memesan Pupuk KOHEMAX?
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-lime-100 mb-6 sm:mb-8">
            Hubungi kami sekarang untuk pupuk organik berkualitas!
          </p>

          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            <button className="px-6 sm:px-8 py-3 sm:py-4 bg-lime-500 hover:bg-lime-600 text-white font-semibold rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base">
              Pesan Sekarang
            </button>
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <p className="text-lime-200 text-xs sm:text-sm">
              💡 <strong>Tips:</strong> Untuk kebutuhan pertanian besar,
              konsultasikan kebutuhan Anda untuk kemasan khusus
            </p>
          </div>
        </div>
      </section>
