...
const KambingHidupPage = () => {
    ...
    const packages = [
        { weight: 'standar', price: '2.500.000', originalPrice: '2.800.000', type: 'Aqiqah Standar' },
        { weight: 'premium', price: '3.500.000', originalPrice: '3.900.000', type: 'Kurban Premium', popular: true },
        { weight: 'investasi', price: 'Call', originalPrice: '', type: 'Investasi Kambing', special: true },
    ...
    const healthFacts = [
        { metric: 'Berat Rata-rata', amount: '25-35kg', color: 'text-green-600', per: 'Kambing' },
        { metric: 'Usia', amount: '1-2 tahun', color: 'text-teal-600', per: 'Kambing' },
        { metric: 'Pakan', amount: '100% Alami', color: 'text-emerald-600', per: 'Kambing' },
        { metric: 'Kesehatan', amount: 'Tersertifikasi', color: 'text-lime-600', per: 'Kambing' }
    ];

    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-lime-50">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-green-700 via-teal-700 to-emerald-800 pt-24 pb-20 min-h-[60vh] flex items-center overflow-hidden text-white">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <p className={`text-lg sm:text-xl text-green-100 leading-relaxed max-w-xl mx-auto lg:mx-0 transition-all duration-800 delay-600 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                                ...
                                Kambing hidup berkualitas dari Embik Farm untuk aqiqah, kurban, dan peranakan. Program investasi penggemukan dan peranakan untuk keuntungan dan dukungan peternak lokal.
                            </p>
                        </div>
                        ...
                        <div className={`grid grid-cols-2 gap-4 w-full max-w-md transition-all duration-800 delay-700 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                            ...
                            <div className="text-center p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                <Zap className="w-6 h-6 text-teal-300 mx-auto mb-1" />
                                <div className="text-sm font-semibold">Pakan Alami</div>
                                <div className="text-xs text-green-200">100% Natural</div>
                            </div>
                            <div className="text-center p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                <Heart className="w-6 h-6 text-emerald-300 mx-auto mb-1" />
                                <div className="text-sm font-semibold">Sehat & Kuat</div>
                        ...
                        <div className="relative bg-white p-4 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 z-10">
                            <div className="w-96 h-96 bg-gradient-to-br from-green-100 via-teal-100 to-emerald-50 rounded-2xl flex items-center justify-center relative">
                                ...
                                <div className="text-center relative">
                                    ...
                                    <div className="text-green-600">Kambing Hidup Premium</div>
                                </div>
            ...
            {/* Health Facts - Modern Design */}
            <section className="py-20 bg-gradient-to-br from-green-50 via-teal-50 to-emerald-50 relative overflow-hidden">
                {/* Animated background elements */}
                <div className="absolute top-0 left-0 w-full h-full">
                    <div className="absolute top-20 left-10 w-32 h-32 bg-green-200 rounded-full opacity-20 animate-pulse"></div>
                    <div className="absolute bottom-20 right-20 w-24 h-24 bg-teal-200 rounded-full opacity-30 animate-bounce" style={{ animationDuration: '3s' }}></div>
                    <div className="absolute top-40 right-40 w-16 h-16 bg-emerald-200 rounded-full opacity-25 animate-ping" style={{ animationDuration: '4s' }}></div>
                </div>

                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        {/* Modern badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full text-sm font-medium mb-6 shadow-lg">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            ...
                            <span className="font-semibold text-green-600"> untuk aqiqah, kurban, dan investasi</span>
                        </p>
                    </div>

                    {/* Health cards with modern design */}
                        ...
                        {healthFacts.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 group-hover:scale-105 border border-gray-100 overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-teal-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                                    ...
                                    <div className="relative z-10 text-center">
                                        ...
                                        <div className="relative mb-4">
                                            <div className={`w-16 h-16 bg-gradient-to-br ${item.color === 'text-green-600' ? 'from-green-400 to-green-600' :
                                                item.color === 'text-teal-600' ? 'from-teal-400 to-teal-600' :
                                                    item.color === 'text-emerald-600' ? 'from-emerald-400 to-emerald-600' :
                                                ...
                                                {item.metric === 'Berat Rata-rata' && <Scale className="w-8 h-8 text-white" />}
                                                {item.metric === 'Usia' && <Calendar className="w-8 h-8 text-white" />}
                                                {item.metric === 'Pakan' && <Sprout className="w-8 h-8 text-white" />}
                                                {item.metric === 'Kesehatan' && <Heart className="w-8 h-8 text-white" />}
                                            </div>

                                            {/* Floating indicator */}
                                            <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-400 to-teal-400 rounded-full flex items-center justify-center shadow-md transform group-hover:scale-125 transition-all duration-300">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs text-gray-500 leading-relaxed">
                                                {item.metric === 'Berat Rata-rata' && 'Ideal untuk berbagai kebutuhan'}
                                                {item.metric === 'Usia' && 'Usia optimal untuk kesehatan'}
                                                {item.metric === 'Pakan' && 'Pakan alami tanpa bahan kimia'}
                                                {item.metric === 'Kesehatan' && 'Diperiksa dan tersertifikasi'}
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-green-200 to-teal-200 rounded-3xl opacity-0 group-hover:opacity-20 transform translate-y-2 group-hover:translate-y-4 transition-all duration-500 -z-10 blur-xl"></div>
                            </div>
                        ))}
                    </div>
                        ...
                        <div className="inline-flex flex-col sm:flex-row items-center gap-6 px-8 py-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <div className="font-bold text-gray-800">Kualitas Terjamin</div>
                                    <div className="text-sm text-gray-600">Sehat & tersertifikasi</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <div className="font-bold text-gray-800">Pakan Alami</div>
                                    <div className="text-sm text-gray-600">Bebas bahan kimia</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <div className="font-bold text-gray-800">Investasi Menguntungkan</div>
                                    <div className="text-sm text-gray-600">Bagi hasil menarik</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Benefits Section */}
            <section className="py-24 bg-gradient-to-br from-gray-50 via-green-50/30 to-teal-50/50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            Kambing hidup premium untuk aqiqah, kurban, dan investasi, mendukung peternak lokal
                        </p>
                    </div>
            ...
            <section className="py-20 bg-gradient-to-r from-green-50 to-teal-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl sm:text-4xl font-bold text-green-800 mb-4">Pilihan Jenis & Paket</h2>
                        <p className="text-lg text-green-600">Sesuaikan dengan kebutuhan aqiqah, kurban, atau investasi Anda</p>
                    </div>

                    {/* Type Selection */}
                    <div className="mb-12">
                        <h3 className="text-xl font-semibold text-green-800 mb-6 text-center">Pilih Jenis Kambing</h3>
                                ...
                                >
                                    {type.popular && (
                                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                                            <span className="bg-teal-500 text-white px-4 py-1 rounded-full text-sm font-bold">Terpopuler</span>
                                        </div>
                                    )}
                                    <div className={`w-20 h-20 bg-gradient-to-br ${type.color} rounded-full mx-auto mb-4 flex items-center justify-center shadow-md`}>
                                        <Tractor className={`w-10 h-10 text-${type.accent}`} />
                                    </div>
                    ...
                    {/* Package Selection */}
                    <div>
                        <h3 className="text-xl font-semibold text-green-800 mb-6 text-center">Pilih Paket</h3>
                            ...
                            {packages.map((pkg) => (
                                <div
                                    ...
                                    className={`relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${selectedPackage === pkg.weight ? 'ring-4 ring-green-500' : ''
                                        } ${pkg.popular ? 'ring-2 ring-teal-400' : ''} ${pkg.special ? 'ring-2 ring-emerald-500' : ''}`}
                                ...
                                >
                                    ...
                                    {pkg.special && (
                                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                                            <span className="bg-emerald-500 text-white px-4 py-1 rounded-full text-sm font-bold">Special</span>
                                        </div>
                                    )}
                    ...
                    <div className="text-center mt-16">
                        <div className="inline-flex items-center gap-4 px-8 py-4 bg-white rounded-2xl shadow-lg border border-green-100">
                            ...
                            <div className="flex items-center gap-2 text-teal-600">
                                ...
                                <span className="font-semibold">Jaminan kesehatan & kualitas</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 bg-gradient-to-br from-green-700 via-teal-700 to-emerald-800 text-white">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">Siap Memilih Kambing Hidup Berkualitas?</h2>
                    <p className="text-xl text-teal-100 mb-8">Hubungi kami untuk aqiqah, kurban, atau investasi ternak!</p>

                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <button className="px-8 py-4 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                            Pesan Sekarang
                        </button>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-teal-200 text-sm">
                            💡 <strong>Tips:</strong> Untuk aqiqah/kurban, pesan H-7 untuk kualitas terbaik. Tanyakan program investasi!
                        </p>
                    </div>
                </div>
            </section>
