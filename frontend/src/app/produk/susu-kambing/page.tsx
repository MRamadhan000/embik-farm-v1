...
const SusuKambingPage = () => {
  const [isLoaded, setIsLoaded] = useState(false);
  const [scrollY, setScrollY] = useState(0);
  const [selectedFlavor, setSelectedFlavor] = useState("original");
  const [selectedPackage, setSelectedPackage] = useState("250ml");
  ...
  const flavors = [
    {
      name: "original",
      title: "Original GEMIK",
      description: "Susu kambing murni dengan rasa alami",
    ...
    {
      name: "stroberi",
      title: "Stroberi GEMIK",
      description: "Susu kambing dengan aroma stroberi segar",
    ...
    },
    {
      name: "coklat",
      title: "Coklat GEMIK",
      description: "Susu kambing dengan rasa coklat lezat",
  ...
  const benefits = [
    {
      ...
      title: "Tinggi Omega-3",
      description: "Mendukung kesehatan jantung dan fungsi otak",
    },
    {
      icon: <Droplet className="w-6 sm:w-8 h-6 sm:h-8 text-cyan-600" />,
      title: "Rendah Laktosa",
      description: "Lebih mudah dicerna, cocok untuk intoleransi laktosa",
    },
    {
      icon: <Scale className="w-6 sm:w-8 h-6 sm:h-8 text-green-600" />,
      title: "Kaya Kalsium",
      description: "Memperkuat tulang dan gigi untuk semua usia",
    },
    {
      icon: <Shield className="w-6 sm:w-8 h-6 sm:h-8 text-lime-600" />,
      title: "Pasteurisasi Higienis",
      description: "Diproses dengan standar kebersihan, siap minum",
    },
    {
      icon: <Users className="w-6 sm:w-8 h-6 sm:h-8 text-amber-600" />,
      title: "Beragam Rasa & Ukuran",
      description: "Varian original, stroberi, coklat dalam kemasan fleksibel",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-amber-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-700 via-cyan-700 to-amber-800 pt-16 sm:pt-20 lg:pt-24 pb-12 sm:pb-16 lg:pb-20 min-h-[50vh] sm:min-h-[60vh] flex items-center overflow-hidden text-white">
        {/* Background decorative elements - Hidden on mobile */}
        <div
          className="hidden sm:block absolute top-20 right-10 w-24 sm:w-32 h-24 sm:h-32 bg-cyan-300 rounded-full opacity-30 blur-3xl transition-transform duration-1000 ease-out"
          style={{
        ...
        ></div>
        <div
          className="hidden sm:block absolute bottom-20 left-10 w-32 sm:w-40 h-32 sm:h-40 bg-blue-300 rounded-full opacity-20 blur-3xl transition-all duration-1000 ease-out delay-300"
          style={{
            transform: `translateY(${parallaxSlow}px) ${
              isLoaded ? "scale(1)" : "scale(0)"
            }`,
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 relative z-10">
          ...
          >
            {/* Badge */}
            <div
              className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-500/20 text-white text-xs sm:text-sm font-semibold rounded-full border border-blue-300/40 shadow-sm transition-all duration-700 delay-200 ${
                isLoaded
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              ...
              >
                <span className="block text-cyan-200">Susu Kambing</span>
                <span className="block">GEMIK</span>
              </h1>

              <p
                className={`text-sm sm:text-base lg:text-lg xl:text-xl text-blue-100 leading-relaxed max-w-xl mx-auto lg:mx-0 transition-all duration-800 delay-600 px-4 sm:px-0 ${
                  isLoaded
                    ? "translate-y-0 opacity-100"
                    : "translate-y-6 opacity-0"
                }`}
              >
                Susu kambing pasteurisasi segar dari kambing pilihan dengan
                pakan alami. Kaya Omega-3, protein, dan kalsium, tersedia dalam
                varian original, stroberi, dan coklat.
              </p>
            </div>
            ...
            >
              <div className="text-center p-2 sm:p-3 bg-white/10 rounded-lg sm:rounded-xl backdrop-blur-sm">
                <Zap className="w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 text-cyan-300 mx-auto mb-1" />
                <div className="text-xs sm:text-sm font-semibold">
                  Tinggi Omega-3
                </div>
                <div className="text-xs text-blue-200">0.1g/100ml</div>
              </div>
              <div className="text-center p-2 sm:p-3 bg-white/10 rounded-lg sm:rounded-xl backdrop-blur-sm">
                ...
                <div className="text-xs text-blue-200">Mudah dicerna</div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm">
                <div className="w-2 sm:w-3 h-2 sm:h-3 bg-blue-300 rounded-full"></div>
                <span>Konsumsi Harian</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm">
                <div className="w-2 sm:w-3 h-2 sm:h-3 bg-cyan-300 rounded-full"></div>
                <span>Anak-anak</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 bg-white/10 rounded-full text-xs sm:text-sm">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 via-cyan-50 to-amber-50 relative overflow-hidden">
        {/* Animated background elements - Hidden on mobile */}
        <div className="hidden sm:block absolute top-0 left-0 w-full h-full">
          <div className="absolute top-20 left-10 w-32 h-32 bg-blue-200 rounded-full opacity-20 animate-pulse"></div>
          <div
            className="absolute bottom-20 right-20 w-24 h-24 bg-cyan-200 rounded-full opacity-30 animate-bounce"
            style={{ animationDuration: "3s" }}
          ></div>
          <div
            className="absolute top-40 right-40 w-16 h-16 bg-amber-200 rounded-full opacity-25 animate-ping"
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            {/* Modern badge */}
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6 shadow-lg">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
              Susu kambing GEMIK dengan kandungan nutrisi optimal
            ...
            {nutritionFacts.map((item, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 lg:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 sm:hover:-translate-y-3 group-hover:scale-105 border border-gray-100 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-cyan-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl sm:rounded-3xl"></div>
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="relative mb-2 sm:mb-3 lg:mb-4">
                      ...
                      {/* Floating indicator */}
                      <div className="absolute -top-1 sm:-top-2 -right-1 sm:-right-2 w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full flex items-center justify-center shadow-md transform group-hover:scale-125 transition-all duration-300">
                ...
                <div className="hidden sm:block absolute inset-0 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-20 transform translate-y-2 group-hover:translate-y-4 transition-all duration-500 -z-10 blur-xl"></div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 sm:mt-12 lg:mt-16 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 lg:gap-6 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-white/50">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-lg sm:rounded-xl flex items-center justify-center">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 bg-gradient-to-r from-amber-400 to-amber-600 rounded-lg sm:rounded-xl flex items-center justify-center">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-gray-50 via-blue-50/30 to-cyan-50/50 relative overflow-hidden">
        ...
        <div className="hidden sm:block absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-cyan-100 rounded-full opacity-15 blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-10 sm:mb-16 lg:mb-20">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 lg:px-6 py-1.5 sm:py-2 lg:py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6 lg:mb-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
              Susu kambing premium dengan nutrisi tinggi untuk kesehatan
              keluarga
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform group-hover:-translate-y-2 sm:group-hover:-translate-y-4 group-hover:scale-105 border border-gray-100/50 backdrop-blur-sm overflow-hidden">
                  {/* Gradient overlay on hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-transparent to-cyan-50 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl sm:rounded-3xl"></div>
                  ...
                  <div className="relative z-10">
                    <h3 className="text-base sm:text-lg lg:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 lg:mb-4 group-hover:text-blue-600 transition-colors duration-300 leading-tight">
                      {benefit.title}
                    </h3>
                    ...
                    <div className="hidden sm:flex items-center gap-2 mt-4 lg:mt-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                      <div className="w-1 h-6 lg:h-8 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full"></div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-blue-50 to-cyan-50">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-800 mb-2 sm:mb-3 lg:mb-4">
              Pilihan Rasa & Kemasan
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-blue-600">
          ...
          <div className="mb-8 sm:mb-10 lg:mb-12">
            <h3 className="text-lg sm:text-xl font-semibold text-blue-800 mb-4 sm:mb-5 lg:mb-6 text-center">
              Pilih Rasa Susu
            </h3>
                ...
                <div
                  ...
                  className={`relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${
                    selectedFlavor === flavor.name
                      ...
                      : ""
                  } ${flavor.popular ? "ring-2 ring-cyan-400" : ""}`}
                  onClick={() => setSelectedFlavor(flavor.name)}
                >
                  {flavor.popular && (
                    <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2">
                      <span className="bg-cyan-500 text-white px-2 sm:px-3 lg:px-4 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-bold">
                        Terpopuler
                      </span>
                    </div>
                  )}
                  <div
                    className={`w-12 sm:w-16 lg:w-20 h-12 sm:h-16 lg:h-20 bg-gradient-to-br ${flavor.color} rounded-full mx-auto mb-2 sm:mb-3 lg:mb-4 flex items-center justify-center shadow-md`}
                  >
                    <Droplet
                      className={`w-6 sm:w-8 lg:w-10 h-6 sm:h-8 lg:h-10 text-${flavor.accent}`}
                    />
                  </div>
                  <h3 className="text-base sm:text-lg lg:text-xl font-bold text-blue-800 text-center mb-1 sm:mb-2">
                    {flavor.title}
                  </h3>
              ...
              {packages.map((pkg) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-800 mb-1 sm:mb-2">
                      {pkg.weight}
                    </div>
                    <div className="text-xs sm:text-sm text-blue-600 mb-2 sm:mb-3">
                      {pkg.type}
                    </div>
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600 mb-0.5 sm:mb-1">
                      {pkg.price === "Call"
                        ? "Hubungi Kami"
                        : `Rp ${pkg.price}`}
                    </div>
                    ...
                    <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-blue-600 mb-4 sm:mb-5 lg:mb-6">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 justify-center">
                        <CheckCircle className="w-3 sm:w-4 h-3 sm:h-4" />
                        <span>Pasteurisasi higienis</span>
                      </div>
                      <div className="flex items-center gap-1.5 sm:gap-2 justify-center">
                        <CheckCircle className="w-3 sm:w-4 h-3 sm:h-4" />
                    ...
                    <button className="w-full bg-blue-600 text-white py-2 sm:py-2.5 lg:py-3 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        {/* Background decorative elements - Hidden on mobile */}
        <div className="hidden sm:block absolute top-10 left-10 w-64 h-64 bg-blue-100 rounded-full opacity-30 blur-3xl"></div>
        <div className="hidden sm:block absolute bottom-10 right-10 w-48 h-48 bg-cyan-100 rounded-full opacity-40 blur-2xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-600 max-w-2xl mx-auto px-4 sm:px-0">
              4 langkah sederhana untuk mendapatkan susu kambing GEMIK
              berkualitas
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7 lg:gap-8 relative">
            ...
            <div className="hidden lg:block absolute top-16 sm:top-20 lg:top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-blue-200 to-transparent"></div>
            ...
            {[
              ...
              },
              {
                step: "02",
                title: "Konfirmasi",
                desc: "Tentukan rasa, kemasan, dan jadwal pengambilan",
                icon: (
              ...
              },
              {
                step: "03",
                title: "Proses",
                desc: "Susu diproses dengan pasteurisasi higienis",
                icon: (
                  <Droplet className="w-5 sm:w-6 lg:w-8 h-5 sm:h-6 lg:h-8" />
                ),
              ...
              >
                ...
                <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 sm:hover:-translate-y-2 relative overflow-hidden group-hover:scale-105 border border-gray-100">
                  ...
                  <div className="text-center relative z-10">
                    <h3 className="text-base sm:text-lg lg:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-blue-600 transition-colors duration-300">
                      {item.title}
                    </h3>
                ...
                {index < 3 && (
                  <div className="hidden lg:block absolute top-16 sm:top-20 lg:top-24 -right-4 z-20">
                    <div className="w-6 sm:w-8 h-6 sm:h-8 bg-white border-2 border-blue-200 rounded-full flex items-center justify-center shadow-sm">
          ...
          <div className="text-center mt-10 sm:mt-12 lg:mt-16">
            <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-100">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-700 via-cyan-700 to-amber-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-3 sm:px-4 md:px-6 lg:px-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-2 sm:mb-3 lg:mb-4">
            Siap Menikmati Susu Kambing GEMIK?
          </h2>
          <p className="text-sm sm:text-base lg:text-xl text-cyan-100 mb-6 sm:mb-7 lg:mb-8 px-4 sm:px-0">
            Hubungi kami sekarang untuk susu segar dan berkualitas!
          </p>

          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 justify-center mb-6 sm:mb-7 lg:mb-8">
            <button className="px-6 sm:px-7 lg:px-8 py-3 sm:py-3.5 lg:py-4 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base">
              Pesan Sekarang
            </button>
            <button className="px-6 sm:px-7 lg:px-8 py-3 sm:py-3.5 lg:py-4 border-2 border-white text-white hover:bg-white hover:text-blue-800 font-semibold rounded-xl sm:rounded-2xl transition-all duration-300 text-sm sm:text-base">
              Konsultasi Dulu
            </button>
          </div>
          ...
          <div className="text-center">
            <p className="text-cyan-200 text-xs sm:text-sm px-4 sm:px-0">
              💡 <strong>Tips:</strong> Untuk konsumsi rutin, pilih kemasan
              500ml atau 1L agar lebih hemat
            </p>
          </div>
        </div>
...
export default SusuKambingPage;
