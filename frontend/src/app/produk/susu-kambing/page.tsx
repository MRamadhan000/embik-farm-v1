...
const SusuKambingPage = () => {
    ...
    const packages = [
        { weight: '250ml', price: '15.000', originalPrice: '18.000', type: 'Coba Dulu' },
        { weight: '500ml', price: '28.000', originalPrice: '32.000', type: 'Konsumsi Harian', popular: true },
        { weight: '1L', price: '50.000', originalPrice: '58.000', type: 'Keluarga' },
    ...
    const nutritionFacts = [
        { nutrient: 'Protein', amount: '3.7g', color: 'text-blue-600', per: '100ml' },
        { nutrient: 'Kalsium', amount: '120mg', color: 'text-green-600', per: '100ml' },
        { nutrient: 'Omega-3', amount: '0.1g', color: 'text-cyan-600', per: '100ml' },
        { nutrient: 'Kalori', amount: '60 kcal', color: 'text-amber-600', per: '100ml' }
    ];

    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-amber-50">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-blue-700 via-cyan-700 to-amber-800 pt-24 pb-20 min-h-[60vh] flex items-center overflow-hidden text-white">
                {/* Background decorative elements */}
                <div
                    className="absolute top-20 right-10 w-32 h-32 bg-cyan-300 rounded-full opacity-30 blur-3xl transition-transform duration-1000 ease-out"
                    style={{
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 relative z-10">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <p className={`text-lg sm:text-xl text-blue-100 leading-relaxed max-w-xl mx-auto lg:mx-0 transition-all duration-800 delay-600 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                                }`}>
                                Susu kambing pasteurisasi segar dari kambing pilihan dengan pakan alami. Kaya Omega-3, protein, dan kalsium, tersedia dalam varian original, stroberi, dan coklat.
                            </p>
                        </div>
                        ...
                        <div className={`grid grid-cols-2 gap-4 w-full max-w-md transition-all duration-800 delay-700 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
                            ...
                            <div className="text-center p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                <Zap className="w-6 h-6 text-cyan-300 mx-auto mb-1" />
                                <div className="text-sm font-semibold">Tinggi Omega-3</div>
                                <div className="text-xs text-blue-200">0.1g/100ml</div>
                            </div>
                            <div className="text-center p-3 bg-white/10 rounded-xl backdrop-blur-sm">
                                <Heart className="w-6 h-6 text-green-300 mx-auto mb-1" />
                                <div className="text-sm font-semibold">Rendah Laktosa</div>
                    ...
                    <div className={`w-full lg:w-1/2 flex justify-center lg:justify-end relative transition-all duration-1000 ease-out delay-300 ${isLoaded ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'
                        ...
                        <div className="relative bg-white p-4 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 z-10">
                            <div className="w-96 h-96 bg-gradient-to-br from-blue-100 via-cyan-100 to-amber-50 rounded-2xl flex items-center justify-center relative">
                                {/* Product illustration */}
                                <div className="text-center relative">
                                    <div className="w-32 h-32 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                                        <Droplet className="w-16 h-16 text-blue-700" />
                                    </div>
                                    <div className="text-2xl font-bold text-blue-800">GEMIK</div>
                                    <div className="text-blue-600">Susu Kambing Premium</div>
                                </div>
                            ...
                            {/* Quality Badge */}
                            <div className={`absolute -top-4 -right-4 bg-blue-600 text-white px-4 py-2 rounded-full shadow-lg transform rotate-12 z-20 transition-all duration-700 delay-1000 flex items-center gap-1 ${isLoaded ? 'scale-100 opacity-100' : 'scale-0 opacity-0'
                                }`}>
            ...
            <section className="py-20 bg-gradient-to-br from-blue-50 via-cyan-50 to-amber-50 relative overflow-hidden">
                {/* Animated background elements */}
                <div className="absolute top-0 left-0 w-full h-full">
                    <div className="absolute top-20 left-10 w-32 h-32 bg-blue-200 rounded-full opacity-20 animate-pulse"></div>
                    <div className="absolute bottom-20 right-20 w-24 h-24 bg-cyan-200 rounded-full opacity-30 animate-bounce" style={{ animationDuration: '3s' }}></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        {/* Modern badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm font-medium mb-6 shadow-lg">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            ...
                            <span className="font-semibold text-blue-600"> per 100 ml</span> untuk kesehatan keluarga
                        </p>
                    </div>
                        ...
                        {nutritionFacts.map((item, index) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 group-hover:scale-105 border border-gray-100 overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-cyan-50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                                    ...
                                    <div className="relative z-10 text-center">
                                        ...
                                        <div className="relative mb-4">
                                            <div className={`w-16 h-16 bg-gradient-to-br ${item.color === 'text-blue-600' ? 'from-blue-400 to-blue-600' :
                                                item.color === 'text-green-600' ? 'from-green-400 to-green-600' :
                                                    item.color === 'text-cyan-600' ? 'from-cyan-400 to-cyan-600' :
                                                ...
                                                {item.nutrient === 'Omega-3' && <Shield className="w-8 h-8 text-white" />}
                                                {item.nutrient === 'Kalori' && <Award className="w-8 h-8 text-white" />}
                                            </div>

                                            {/* Floating indicator */}
                                            <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full flex items-center justify-center shadow-md transform group-hover:scale-125 transition-all duration-300">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-xs text-gray-500 leading-relaxed">
                                                ...
                                                {item.nutrient === 'Kalsium' && 'Memperkuat tulang & gigi'}
                                                {item.nutrient === 'Omega-3' && 'Mendukung jantung & otak'}
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-blue-200 to-cyan-200 rounded-3xl opacity-0 group-hover:opacity-20 transform translate-y-2 group-hover:translate-y-4 transition-all duration-500 -z-10 blur-xl"></div>
                            </div>
                        ))}
                    </div>
                        ...
                        <div className="inline-flex flex-col sm:flex-row items-center gap-6 px-8 py-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <div className="font-bold text-gray-800">Rendah Laktosa</div>
                                    <div className="text-sm text-gray-600">Mudah dicerna</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <div className="font-bold text-gray-800">Tinggi Omega-3</div>
                                    <div className="text-sm text-gray-600">Baik untuk jantung</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-sm text-gray-600">Pasteurisasi higienis</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* Benefits Section */}
            <section className="py-24 bg-gradient-to-br from-gray-50 via-blue-50/30 to-cyan-50/50 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="text-center mb-20">
                        <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm font-semibold mb-8 shadow-lg transform hover:scale-105 transition-transform duration-300">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            Susu kambing premium dengan nutrisi tinggi untuk kesehatan keluarga
                        </p>
                    </div>
                        ...
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform group-hover:-translate-y-4 group-hover:scale-105 border border-gray-100/50 backdrop-blur-sm overflow-hidden">
                                    {/* Gradient overlay on hover */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-transparent to-cyan-50 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-3xl"></div>
                                    ...
                                    <div className="relative z-10 mb-6">
                                        <div className="relative">
                                            ...
                                            <div className={`w-20 h-20 ${index === 0 ? 'bg-gradient-to-br from-blue-400 to-blue-600' :
                                                index === 1 ? 'bg-gradient-to-br from-cyan-400 to-cyan-600' :
                                            ...
                                            <div className={`absolute -top-2 -right-2 w-8 h-8 ${index === 0 ? 'bg-blue-500' :
                                                index === 1 ? 'bg-cyan-500' :
                                    ...
                                    {/* Bottom accent line */}
                                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-100 rounded-b-3xl overflow-hidden">
                                        <div className={`h-full ${index === 0 ? 'bg-gradient-to-r from-blue-400 to-blue-600' :
                                ...
                                <div className={`absolute inset-0 ${index === 0 ? 'bg-gradient-to-br from-blue-200 to-blue-300' :
                                    index === 1 ? 'bg-gradient-to-br from-cyan-200 to-cyan-300' :
                                        index === 2 ? 'bg-gradient-to-br from-green-200 to-green-300' :
            ...
            <section className="py-20 bg-gradient-to-r from-blue-50 to-cyan-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl sm:text-4xl font-bold text-blue-800 mb-4">Pilihan Rasa & Kemasan</h2>
                        <p className="text-lg text-blue-600">Sesuaikan dengan selera dan kebutuhan Anda</p>
                    </div>

                    {/* Flavor Selection */}
                    <div className="mb-12">
                        <h3 className="text-xl font-semibold text-blue-800 mb-6 text-center">Pilih Rasa Susu</h3>
                                ...
                                >
                                    {flavor.popular && (
                                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                                            <span className="bg-cyan-500 text-white px-4 py-1 rounded-full text-sm font-bold">Terpopuler</span>
                                        </div>
                                    )}
                                    <div className={`w-20 h-20 bg-gradient-to-br ${flavor.color} rounded-full mx-auto mb-4 flex items-center justify-center shadow-md`}>
                                        <Droplet className={`w-10 h-10 text-${flavor.accent}`} />
                                    </div>
                                    <h3 className="text-xl font-bold text-blue-800 text-center mb-2">{flavor.title}</h3>
                                    <p className="text-blue-600 text-center text-sm">{flavor.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    {/* Package Selection */}
                    <div>
                        <h3 className="text-xl font-semibold text-blue-800 mb-6 text-center">Pilih Kemasan</h3>
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {packages.map((pkg) => (
                                <div
                                    key={pkg.weight}
                                    className={`relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${selectedPackage === pkg.weight ? 'ring-4 ring-blue-500' : ''
                                        } ${pkg.popular ? 'ring-2 ring-cyan-400' : ''} ${pkg.special ? 'ring-2 ring-amber-500' : ''}`}
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
                ...
                <div className="absolute bottom-10 right-10 w-48 h-48 bg-cyan-100 rounded-full opacity-40 blur-2xl"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            4 langkah sederhana untuk mendapatkan susu kambing GEMIK berkualitas
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-16">
                        <div className="inline-flex items-center gap-4 px-8 py-4 bg-white rounded-2xl shadow-lg border border-blue-100">
                            ...
                            <div className="flex items-center gap-2 text-cyan-600">
                                ...
                                <span className="font-semibold">Jaminan higienis & segar</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* CTA Section */}
            <section className="py-20 bg-gradient-to-br from-blue-700 via-cyan-700 to-amber-800 text-white">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">Siap Menikmati Susu Kambing GEMIK?</h2>
                    <p className="text-xl text-cyan-100 mb-8">Hubungi kami sekarang untuk susu segar dan berkualitas!</p>

                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <button className="px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                            Pesan Sekarang
                        </button>
                        <button className="px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-blue-800 font-semibold rounded-2xl transition-all duration-300">
                            Konsultasi Dulu
                        </button>
                    </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-cyan-200 text-sm">
                            💡 <strong>Tips:</strong> Untuk konsumsi rutin, pilih kemasan 500ml atau 1L agar lebih hemat
                        </p>
                    </div>
                </div>
            </section>
